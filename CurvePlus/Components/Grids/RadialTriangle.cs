...
{
    public class RadialTriangle : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the RadialTriangle class.
        /// </summary>
        public RadialTriangle()
          : base("Radial Triangle Grid", "RadTriGrid",
              "2D Radial Triangle Grid",
              "Vector", "Grid")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            for (int i = 0; i < countR - 1; i++)
            {
                for (int j = 0; j < countP; j += 2)
                {
                    ...
                    cellA.Add(points[u][vb]);
                    cellA.Add(points[u][vc]);
                    cellA.Add(points[i][va]);

                    cells.Add(cellA.ToNurbsCurve());

                    Polyline cellB = new Polyline();
                    cellB.Add(points[u][vc]);
                    cellB.Add(points[i][vd]);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.CP_Grid_TriangleA_01;
            }
        }
        ...
        {
            get { return new Guid("68cf2b77-740b-4bb5-8f52-ed07744dcce4"); }
        }
    }
}